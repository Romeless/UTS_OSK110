...
class Segmenter(object):
    ...
    def __init__(self, spatial_radius=None, range_radius=None, min_density=None, speedup_level=2):
        '''
        ...
        if speedup_level == 0:
            self.speedup_level = SPEEDUP_NO
        elif speedup_level == 1:
            self.speedup_level = SPEEDUP_MEDIUM
        else:
            self.speedup_level = SPEEDUP_HIGH
